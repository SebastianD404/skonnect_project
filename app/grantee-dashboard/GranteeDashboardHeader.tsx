    ...
    <header className="sticky top-0 z-50 border-b border-white/50 bg-gradient-to-b from-[#FAFBFC]/95 to-[#F5F7FB]/90 backdrop-blur-xl shadow-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-1 text-sm md:flex">
          <Link href="/grantee-dashboard" className={navClass(pathname, "/grantee-dashboard")}>Overview</Link>
          <Link href="/grantee-dashboard/documents" className={navClass(pathname, "/grantee-dashboard/documents")}>Submissions</Link>
          <Link href="/grantee-dashboard/events" className={navClass(pathname, "/grantee-dashboard/events")}>Events</Link>
          <Link href="/grantee-dashboard/announcements" className={navClass(pathname, "/grantee-dashboard/announcements")}>Announcements</Link>
        </nav>
